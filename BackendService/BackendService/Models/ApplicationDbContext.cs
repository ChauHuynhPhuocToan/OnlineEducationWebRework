...
namespace BackendService.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.AccountInventoryID).UseIdentityColumn();
                entity.HasOne(e => e.Account).WithMany(d => d.AccountInventories).HasForeignKey(d => d.AccountId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(e => e.Course).WithMany(d => d.AccountInventories).HasForeignKey(d => d.CourseId).OnDelete(DeleteBehavior.Restrict);
            });
            modelBuilder.Entity<QuizAttempt>(entity =>
            {
                entity.Property(e => e.QuizAttemptID).UseIdentityColumn();
            });
