...
export class CreateexamComponent implements OnInit {
  ...
  isCheck : boolean[];
  quizCode;
  constructor(private route: ActivatedRoute,private quizService: QuizService, private router: Router,private choiceService:ChoiceService,private chRef: ChangeDetectorRef,
  ...
  showOptions(event:any,quiz:Quiz): void {
    ...
    if(event == true){
      ...
      if(this.examQuizService.quizExam.length == 0){
        ...
        id = this.examQuizService.quizExam[0].examQuizCode;
        console.log(id);
      }
      var examquiz = new ExamQuiz();
      examquiz.examQuizCode = id;
