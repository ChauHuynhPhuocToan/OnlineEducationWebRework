...
export class QuestionpoolService {
  ...
  filterQuestionpool = async (dateSort,hastag,namesearch,accountId) => {
    try {
      hastag = (hastag) ? hastag : '-1';
      var urlString = this.urlAPI+"FilterQuestionpool?createdDate="+dateSort+"&hastag="+hastag+"&questionpoolName="+namesearch+"&accountId="+accountId;
